...
export default function Dropdown({ className, disabled, label, name, options, value, onChange, error }: dropdownProps) {
    ...
    return (
        <div className={`relative flex flex-col gap-1 ${className}`}>
            ...
            <div className={`flex items-center relative rounded-[12px] bg-transparent w-full py-1 pl-1 border duration-500 z-[1] bg-white w-full p-1 px-1 duration-500 md:shadow-[0px_0px_13px_5px_#FFFFFF12_inset] shadow-[0px_0px_9.52px_3.66px_#FFFFFF12_inset] 
            ...
            `}>
                ...
                <select
                    className={`p-0 w-[97%] text-[12px] outline-none bg-transparent cursor-pointer
                        ${className} 
